...
peer lifecycle chaincode approvefromyorg -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com -C --channelID mychannel --name fabcounter --version 1.0 --package-id $PACKAGE_ID --sequence 1 --tls \
